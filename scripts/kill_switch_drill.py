...
async def main_async() -> None:
    parser = argparse.ArgumentParser(
        description="Run SUPER_TRADEMAN Operational Safety Drills"
    )
    parser.add_argument(
        "--drill", type=str, default="all", help="Drill name (1..7, name, or 'all')"
    )
    parser.add_argument(
        "--mode",
        type=str,
        default="SHADOW",
        help="Execution mode (SHADOW, PAPER, DRILL)",
    )
    parser.add_argument(
        "--format",
        type=str,
